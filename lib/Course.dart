...
class _CourseState extends State<Course> {
  ...
  @override
  void initState() {
    futureFile = FirebaseStorage.instance.ref("video/course ${Constants.titleofcourse}").listAll();
    print("${FirebaseStorage.instance.ref("video/course ${Constants.titleofcourse}")}=============================" );
    super.initState();
  }
  @override
  void dispose() {
      ...
      body:
        GetBuilder<getxcontroller>(
          ...
          builder: (getxcontroller) =>
           FutureBuilder<ListResult>(builder: (BuildContext context,AsyncSnapshot snapshot) {
            if(snapshot.hasData){
              ...
              return ListView.builder(
                ...
                final file = files[index];
                 return ListTile(title: Text(file.name),onTap: () async{
                   Constants.vidurlvew = [];
