      ...
      Container(
        ...
        child: Form(
          ...
          child: ListView(
            ...
            Row(
              children: [
                Flexible(child: TextFormField(
                  decoration: InputDecoration(hintText: "First Name : ",border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
                validator: (value) {
                  if(value!.length < 2){
                ...
                SizedBox(height: 20,),
                Flexible(child: TextFormField(
                  decoration: InputDecoration(hintText: "Last Name : ",border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
                  validator: (value) {
                    if(value!.length < 2){
            ...
            SizedBox(height: 20,),
            TextFormField(
              decoration: InputDecoration(hintText: "Username : ",border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
              validator: (value) {
                if(value!.length < 2){
